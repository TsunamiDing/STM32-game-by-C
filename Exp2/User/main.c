...
u32 ballx2 = 240;  u32 bally2 = 513;
u32 ballx3 = 240;  u32 bally3 = 257;
u32 right = 1;     u32 up = 0;
u32 right2 = 0;    u32 up2 = 0;
u32 right3 = 1;    u32 up3 = 0;
...
void TIM2_IRQHandler(void)
{
	...
	TIM2->SR &= ~(1<<0); //Add comments
}

void TIM4_IRQHandler(void)
{
	if (TIM4->SR & 1<<0) //Add comments
	{
		Game2();
	}
	TIM4->SR &= ~(1<<0); //Add comments
}
...
void GameBall(void)
{
	...
	if ((((ballx-ballx2)*(ballx-ballx2))+((bally-bally2)*(bally-bally2)))<=225)
	{
		if (right==1){right=0;}
		if (right==0){right=1;}
		if (up==1){up=0;}
	...
	if ((((ballx-ballx3)*(ballx-ballx3))+((bally-bally3)*(bally-bally3)))<=225)
	{
		if (right==1){right=0;}
		if (right==0){right=1;}
		if (up==1){up=0;}
...
void GameBall2(void)//The second ball with different direction
{
	if (ballx2 <= 15) {right2 = 1;}
	if (ballx2 >= 465) {right2 = 0;}
	if (bally2 <= 30) {up2 = 1;}
	if (bally2 >= 770) {up2 = 0;}

	if ((((ballx-ballx2)*(ballx-ballx2))+((bally-bally2)*(bally-bally2)))<=225)
	{
		if (right2==1){right2=0;}
		if (right2==0){right2=1;}
		if (up2==1){up2=0;}
		if (up2==0){up2=1;}
	}
	
	if ((((ballx3-ballx2)*(ballx3-ballx2))+((bally3-bally2)*(bally3-bally2)))<=225)
	{
		if (right2==1){right2=0;}
		if (right2==0){right2=1;}
		if (up2==1){up2=0;}
	...
	if(dir == 4)
	{
		EIE3810_TFTLCD_DrawCircle(ballx2,bally2,15,1,WHITE);
		if(right2 == 1)
			{ballx2++;}
		if(right2 == 0)
			{ballx2--;}
		...
		if (up2 == 0)
			{bally2-=2;}
		EIE3810_TFTLCD_DrawCircle(ballx2,bally2,15,1,RED);
	}
	...
	if(level==0)
	{
		if ((bally2 <= 30)&((ballx2<x2-40)|(ballx2>x2+40)))
			{GameOver();bally2 = 100;}	
		if ((bally2 >= 770)&((ballx2<x1-40)|(ballx2>x1+40)))
			{GameOver();bally2 = 100;}	
	}	
	
	if(level==1)
	{
		if ((bally2 <= 30)&((ballx2<x2-25)|(ballx2>x2+25)))
			{GameOver();bally2 = 100;}	
		if ((bally2 >= 770)&((ballx2<x1-25)|(ballx2>x1+25)))
			{GameOver();bally2 = 100;}	
	}

		if ((ballx2 <= 15)|(ballx2 >= 465)|(bally2 <= 30)|(bally2 >= 770))
		{
			GPIOB->BSRR = 1<<8;
			Delay(10000);
			GPIOB->BRR = 1<<8;
...
void GameBall3(void)//The third ball with different direction

{
	if (ballx3 <= 15) {right3 = 1;}
	if (ballx3 >= 465) {right3 = 0;}
	if (bally3 <= 30) {up3 = 1;}
	if (bally3 >= 770) {up3 = 0;}

	if ((((ballx3-ballx2)*(ballx3-ballx2))+((bally3-bally2)*(bally3-bally2)))<=225)
	{
		if (right3==1){right3=0;}
		if (right3==0){right3=1;}
		if (up3==1){up3=0;}
		if (up3==0){up3=1;}
	}
	
	if ((((ballx3-ballx)*(ballx3-ballx))+((bally3-bally)*(bally3-bally)))<=225)
	{
		if (right3==1){right3=0;}
		if (right3==0){right3=1;}
		if (up3==1){up3=0;}
	...
	if(dir == 2)
	{
		EIE3810_TFTLCD_DrawCircle(ballx3,bally3,15,1,WHITE);
		if(right3 == 1)
			{ballx3++;}
		if(right3 == 0)
			{ballx3--;}
		...
		if (up3 == 0)
			{bally3-=2;}
		EIE3810_TFTLCD_DrawCircle(ballx3,bally3,15,1,RED);
	}
	...
	if(level==0)
	{
		if ((bally3 <= 30)&((ballx3<x2-40)|(ballx3>x2+40)))
			{GameOver();bally3 = 100;}	
		if ((bally3 >= 770)&((ballx3<x1-40)|(ballx3>x1+40)))
			{GameOver();bally3 = 100;}	
	}	
	
	if(level==1)
	{
		if ((bally3 <= 30)&((ballx3<x2-25)|(ballx3>x2+25)))
			{GameOver();bally3 = 100;}	
		if ((bally3 >= 770)&((ballx3<x1-25)|(ballx3>x1+25)))
			{GameOver();bally3 = 100;}	
	}

		if ((ballx3 <= 15)|(ballx3 >= 465)|(bally3 <= 30)|(bally3 >= 770))
		{
			GPIOB->BSRR = 1<<8;
			Delay(10000);
			GPIOB->BRR = 1<<8;
...
void show_time_bounces(void)
{
	...
	if ((bally <= 40)|(bally >= 760)|(bally2 <= 40)|(bally2 >= 760)|(bally3 <= 40)|(bally3 >= 760))
	{
		bounces++;
	}
...
void GameOver(void)
{
	...
	if ((bally<=770)|(bally2<=770)|(bally3<=770))
	{
		EIE3810_TFTLCD_ShowChar2412(234, 400, 65, RED, BLACK );//A
	}
	
	if ((bally<=30)|(bally2<=30)|(bally3<=30))
	{

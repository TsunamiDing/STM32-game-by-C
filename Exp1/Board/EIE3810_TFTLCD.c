...
void EIE3810_TFTLCD_DrawBackground(u16 color)
{
	int i;
	EIE3810_TFTLCD_WrCmd(0x3600);	
	EIE3810_TFTLCD_WrData(0x0000);
	EIE3810_TFTLCD_WrCmd(0x2C00);
	for (i=0; i<384000; i++){
		EIE3810_TFTLCD_WrData(color);
	}
...
{ 
	if (digit == 0){
		EIE3810_TFTLCD_FillRectangle(start_x+10, 55, start_y, 10, color);
		EIE3810_TFTLCD_FillRectangle(start_x, 10, start_y+10, 55, color);
		EIE3810_TFTLCD_FillRectangle(start_x+65, 10, start_y+10, 55, color);
		EIE3810_TFTLCD_FillRectangle(start_x, 10, start_y+75, 55, color);
		EIE3810_TFTLCD_FillRectangle(start_x+65, 10, start_y+75, 55, color);
		EIE3810_TFTLCD_FillRectangle(start_x+10, 55, start_y+130, 10, color);
	}
	if (digit == 1){
		EIE3810_TFTLCD_FillRectangle(start_x+65, 10, start_y+10, 55, color);
		EIE3810_TFTLCD_FillRectangle(start_x+65, 10, start_y+75, 55, color);
	...
	if (digit == 2){
		EIE3810_TFTLCD_FillRectangle(start_x+10, 55, start_y, 10, color);
		EIE3810_TFTLCD_FillRectangle(start_x+65, 10, start_y+10, 55, color);
		EIE3810_TFTLCD_FillRectangle(start_x+10, 55, start_y+65, 10, color);
		EIE3810_TFTLCD_FillRectangle(start_x, 10, start_y+75, 55, color);
		EIE3810_TFTLCD_FillRectangle(start_x+10, 55, start_y+130, 10, color);
	}
	if (digit == 3){
...
void EIE3810_TFTLCD_ShowChar1608(u16 x, u16 y, u8 ascii, u16 color, u16 bgcolor)
{
	EIE3810_TFTLCD_FillRectangle(x,8,y,16,bgcolor);
	int i,j,k;
	for (i=0;i<16;i++)
	{
		j = asc2_1608[ascii-32][i];
		for (k=0;k<8;k++)
		{
			if (((j>>k)&1)==1)
			{	
				EIE3810_TFTLCD_DrawDot(x+(i/2),y+8-k+(8*(i%2)),color);
			}
		}
	}
}
